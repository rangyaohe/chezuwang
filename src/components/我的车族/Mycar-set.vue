<template>
	<div>
		<div class="set_wrap">
			<div class="set">
				<a href="###" class="aa">基本信息</a>
				<a href="###" class="bb">邮件阅读</a>
				<a href="###" class="cc">收货地址</a>
				<div class="line"></div>
				<div class="setcont_">
					<span class="ff">手机号:</span> <span class="phone dd">15515619809</span>
					<a href="###" class="gh">更换</a><br />
					...
					<span class="ff">用户名:</span> <span class="name dd">vvvzjp</span>
					<a href="###" class="xg1">修改</a><br />
					<span class="ff">密&nbsp;&nbsp; 码:</span> <span class="password dd">········</span>
					<a href="###" class="xg2">修改</a><br />
				</div>
			</div>
		</div>
		<!--弹框-->
			...
			<div class="alert_log">
				...
				<div class="setpassword a3">
					...
					<div class="pp">
						...
						<span class="yyyzm">验证码 </span><input type="text" class="yyyzm_" />
						<a href="" class="hyh"> 看不清楚?换一张</a>
					</div>
